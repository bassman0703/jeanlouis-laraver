...
*/
    ...
    var z = /:[0-9]+$/, B = function (a, b) {
        b && (b = String(b).toLowerCase());
        if ("protocol" === b || "port" === b) a.protocol = A(a.protocol) || A(u.location.protocol);
    ...
    var S = function (a) {
        ...
        return function (b) {
            var c = C(u.location.href), d = c.search.replace("?", "");
            a:{
                var f = d.split("&");
    ...
    var ba = function (a, b, c) {
        ...
        if (u.history && u.history.replaceState) {
            var f = Q("_gl");
            if (f.test(b) || f.test(c)) a = B(a, "path"), b = d(b, "?"), c = d(c, "#"), u.history.replaceState({}, void 0, "" + a + b + c)
        }
    }, T = function (a) {
        var b = void 0 === b ? 3 : b;
        try {
    ...
    function X(a, b, c) {
        if (c && c.action) {
            ...
            if ("get" === d) {
                ...
                f || (d = v.createElement("input"), d.setAttribute("type", "hidden"), d.setAttribute("name", a), d.setAttribute("value", b), c.appendChild(d))
...
*/
    ...
    var gb = wa || "ga", jd = /^(?:utma\.)?\d+\.\d+$/, kd = /^amp-[\w.-]{22,64}$/, Ba = !1;
    var vd = new $c;
    ...
    var bd = function (a) {
        ...
        1 <= 100 * Math.random() || G("?") || (a =
            ["t=error", "_e=" + a, "_v=j85", "sr=1"], b && a.push("_f=" + b), c && a.push("_m=" + K(c.substring(0, 100))), a.push("aip=1"), a.push("z=" + hd()), wc(bd(!0) + "/u/d", a.join("&"), ua))
    };
    var qc = function () {
    ...
    S("exDescription", "exd");
    S("exFatal", "exf");
    var Nc = S("expId", "xid"), Oc = S("expVar", "xvar"), m = S("exp", "exp");
    S("_slexp", void 0);
    var Rc = S("_utma", "_utma"), Sc = S("_utmz", "_utmz"), Tc = S("_utmht", "_utmht"), Ua = S("_hc", void 0, 0),
        Xa = S("_ti", void 0, 0), Wa = S("_to", void 0, 20);
    ...
    var Qb = T("_oot"), dd = S("previewTask"), Rb = S("checkProtocolTask"), md = S("validationTask"),
        ...
        je = T("storeGac", void 0, !0), oe = S("_x_19"), Ae = S("_fplc", "_fplc"), gd = S("transportUrl"),
        Md = S("_r", "_r");
    S("_slc", "_slc");
    var qe = S("_dp"), ad = S("_jt", void 0, "n"), Ud = S("allowAdFeatures", void 0, !0),
    ...
    var Sd = function (a) {
        if (!a.get("dcLoaded") && "cookie" == a.get(ac)) {
            ...
            Pd(b, a, ia);
            Qd(b, a);
            se(a) && (a.set(Md, 1, !0), a.set(ad, "d", !0), J(79), a.set(qe, {
                U: re(a, 1),
                google: re(a, 2),
                V: void 0,
                count: 0
    ...
    var td = function (a, b) {
        ...
        if (a.get(Hd) && (c = be("_ga", !!a.get(cc)),
            g = be("_gl", !!a.get(cc)), d = De.get(a.get(cc)), e = d._ga, g && 0 < g.indexOf("_ga*") && !e && J(30), g = d.gclid, ca = d._gac, c || e || g || ca)) if (c && e && J(36), a.get(bc) || ye(a.get(Kd))) {
        ...
        a.get(Q) || (b = (b = O.gaGlobal) && b.from_cookie && "cookie" !==
        P(a, ac) ? void 0 : (b = b && b.vid) && -1 !== b.search(jd) ? b : void 0, b ? (J(17), a.data.set(Q, b)) : (J(8), a.data.set(Q, ra())));
    ...
    var u = function (a, b, c) {
            ...
            if (!ea(Yd.get(b)) && !$d.get(b)) {
                ...
                if (p.test(b)) {
                    ...
                    (d.clientId = String(c.get(Q)), d.ka = Number(c.get(n)), g = g.palindrome ? r : q, g = (g = M.cookie.replace(/^|(; +)/g, ";").match(g)) ? g.sort().join("").substring(1) : void 0, d.la = g, d.qa = E(P(c, kb), "gclid"));
                    He(d);
                    c = t(d)
                }
                ...
                if (c) {
                    ...
                    c && 0 <= c.indexOf("/") || (c = (l || bd(!1)) + "/plugins/ua/" + c);
                    l = ae(c);
                    a = l.protocol;
                    c = M.location.protocol;
                    if (("https:" == a || a == c || ("http:" != a ? 0 : "http:" == c)) && B(l)) {
                        if (l = l.url) a = (a = M.querySelector && M.querySelector("script[nonce]") ||
                            null) ? a.nonce || a.getAttribute && a.getAttribute("nonce") || "" : "", e ? (e = "", a && Nd.test(a) && (e = ' nonce="' + a + '"'), f.test(l) && M.write("<script" + e + ' src="' + l + '">\x3c/script>')) : (e = M.createElement("script"), e.type = "text/javascript", e.async = !0, e.src = l, a && e.setAttribute("nonce", a), l = M.getElementsByTagName("script")[0], l.parentNode.insertBefore(e, l));
                        $d.set(b, !0)
                    }
                }
            }
