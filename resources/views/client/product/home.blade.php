...
@section('content')
        ...
        <div class="wide78 breadCrumbs">
            <div class="mainPadding">
                <ol itemscope="" itemtype="http://schema.org/BreadcrumbList">
                    ...
                    <span class="current">Urban Care</span>
                </ol>
            </div>
        </div>
        ...
        <div class="wide80">
            <div class="productpage_header">
                ...
                <h1 class="productpage_header_title"><span class="preTitle"><span>Our</span> Products</span> Urban Care</h1>
            </div>
        </div>
        <div class="wide78 productContent">
            <div class="content">
                <div class="right_col">
                    <div id="description_wrapper" class="description_wrapper" style="height: 229px;">
                        <div class="description">
                            <p>Watching women entering Jean Louis David salons each year, the idea was to offer a range of
                                products that was different to all the others... one they discover in our salons and then
                                adopt at home!</p>
                            <p>Complete beauty rituals that combine pleasure and performance to be used in collaboration for
                                amazing hair !</p>
                        </div>
                    </div>
                </div>

                <div class="item productline">
                    <a class=" _hrl" href="/product/detail">
                        <div class="logo">
                            <img
                                src="https://via.placeholder.com/125x42">
                        </div>
                        <img src="https://via.placeholder.com/450x450"
                            class="visuel">
                        <div class="title_wrapper">
                            <div class="table">
                                <a href="/product/detail" class="title">Oil Therapy</a>
                            </div>
                        </div>
                   <a href="/product/detail">    
                     <div class="more_link">
                            <span>Discover</span> the range</div>
                    </a> 
                </div>
            </a>
                <div class="item productline">
                    <a class=" _hrl" href="/product/detail">
                        ...
                        <div class="title_wrapper">
                            <div class="table">
                                <a href="/product/detail" class="title">Go Color</a>
                            </div>
                        </div>

                       <a href="/product/detail"><div class="more_link"><span>Discover</span> the range</div></a>
                    </a> 
                </div>
                <div class="item productline">
                    <a class=" _hrl" href="/product/detail">
                        ...
                        <div class="title_wrapper">
                            <div class="table">
                                <a href="/product/detail" class="title">Express Therapy</a>
                            </div>
                        </div>
                ...
                <div class="item productline">
                    <a class=" _hrl" href="/product/detail">
                        ...
                        <div class="title_wrapper">
                            <div class="table">
                                <a href="/product/detail" class="title">Hydra Therapy</a>
                            </div>
                        </div>
                        <a href="/product/detail"><div class="more_link"><span>Discover</span> the range</div></a>
                ...
                <div class="item productline">
                    <a class=" _hrl" href="/product/detail">
                        ...
                        <div class="title_wrapper">
                            <div class="table">
                                <a href="/product/detail" class="title">Control Therapy</a>
                            </div>
                        </div>
                        <a href="/product/detail"><div class="more_link"><span>Discover</span> the range</div></a>
                    </a>
                ...
                <div class="item productline">
                    <a class=" _hrl" href="/product/detail">
                        ...
                        <div class="title_wrapper">
                            <div class="table">
                                <a href="/product/detail" class="title">Curl Therapy</a>
                            </div>
                        </div>
                        <a href="/product/detail"><div class="more_link"><span>Discover</span> the range</div></a>
                    </a> 
                ...
                <div class="item productline">
                    <a class=" _hrl" href="/product/detail">
                        ...
                        <div class="title_wrapper">
                            <div class="table">
                                <a href="/products/range/go-repair_g70/1" class="title">Go Repair</a>
                            </div>
                        </div>
                ...
                <div class="item productline">
                    <a class=" _hrl" href="/products/range/liss-therapy_g97/1">
                        <div class="logo">
                            <img
                                src="https://via.placeholder.com/125x42">
                        </div>
                        ...
                        <div class="title_wrapper">
                            <div class="table">
                                <a href="/products/range/liss-therapy_g97/1" class="title">Liss Therapy</a>
                            </div>
                        </div>
                       <a href="/product/detail"><div class="more_link"><span>Discover</span> the range</div></a>
                    </a> </div>
                <div class="item productline">
                    <a class=" _hrl" href="/products/range/go-detox_g102/1">
                        <div class="logo">
                            <img
                                src="https://via.placeholder.com/125x42">
                        </div>
                        ...
                        <div class="title_wrapper">
                            <div class="table">
                                <a href="/products/range/go-detox_g102/1" class="title">Go Detox</a>
                            </div>
                        </div>
                      <a href="/product/detail"><div class="more_link"><span>Discover</span> the range</div></a>
                    </a> </div>
                <div class="item productline">
                    <a class=" _hrl" href="/products/range/go-blondie_g104/1">
                        <div class="logo">
                            <img
                                src="https://via.placeholder.com/125x42">
                        </div>
                        ...
                        <div class="title_wrapper">
                            <div class="table">
                                <a href="/products/range/go-blondie_g104/1" class="title">Go Blondie</a>
                            </div>
                        </div>
                        <a href="/product/detail"><div class="more_link"><span>Discover</span> the range</div></a>
                    </a> </div>
                <div class="item productline">
                    <a class=" _hrl" href="/products/range/go-xxl_g110/1">
                        <div class="logo">
                            <img
                                src="https://via.placeholder.com/125x42">
                        </div>
                        ...
                        <div class="title_wrapper">
                            <div class="table">
                                <a href="/products/range/go-xxl_g110/1" class="title">Go XXL</a>
                            </div>
                        </div>
                        <a href="/product/detail"><div class="more_link"><span>Discover</span> the range</div></a>
                    </a>
            ...
            <div class="description_wrapper clone">
                <div class="description">
                    <p>Watching women entering Jean Louis David salons each year, the idea was to offer a range of products
                        that was different to all the others... one they discover in our salons and then adopt at home!</p>
                    <p>Complete beauty rituals that combine pleasure and performance to be used in collaboration for amazing
                        hair !</p>
                </div>
            </div>
        </div>
        ...
        <script>
            WB.utils.fixProductlineDescriptionHeight('#description_wrapper', '.productline');
