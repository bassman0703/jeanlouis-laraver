<html>
    <head>
            ...
            <meta name="description"
                  content="Discover every article published on Jean Louis David. News about the brand and advice for men and women: hairstyles, haircare, colour, trends, new collections, and much more"/>
    ...
    <div id="wb_wrapper">
        ...
        <div id="menuBlock" class="wide78" data-tracking-category="Header" data-tracking-action="Clic rubriques">
            <div class="mainPadding">
                ...
                <img class="headerLogo notSticky" src="{{ asset('img/logo.png')}}" alt="logo">
                    <img class="headerLogo stickyOnly" src=" {{ asset('img/logo-sticky.png')}}" alt="logo">
                </a>
            ...
            <div id="wb_footer">
                <footer>
                    <div class="fullWidth" data-tracking-category="Footer" data-tracking-action="Clic page statique">
                        <div class="wide78">
                            <div class="wrap">
                                <img src="{{ asset('img/logo2.png') }}" class="footerLogo" alt="">
                                <a href="https://reservations.jeanlouisdavid.com"
